...
// // // const OnboardingPage = async () => {
// // //   // GET the user's session details using auth()
...
// // //   }
// // // console.log(orgId)
// // //   // This check is now much cleaner and more reliable.
// // //   // The !! converts the orgId string (or null) into a true/false boolean.
// // //   const isMemberOfOrg = !!orgId;
...
// // //             <OrganizationList
// // //               hidePersonal
// // //               afterSelectOrganizationUrl="/dashboard/onboarding"
...
// // const OnboardingPage = async () => {
// //   // Use currentUser() to get the complete user object from Clerk's API
...
// //   // Safely get the list of all organization memberships.
// //   // The `?? []` provides a default empty array if the property doesn't exist.
// //   const organizationMemberships = clerkUser.organizationMemberships ?? [];
// //   console.log(clerkUser)
// //   // This check is now the most reliable way to see if a user is in ANY organization.
...
// //             <OrganizationList
// //               hidePersonal
// //               // Redirecting back to onboarding is crucial for the status check flow
...
// // THE FIX: This line tells Next.js to always fetch fresh data for this page
// // and never use a cache. This is crucial for onboarding.
...
//   const test =  useOrganization();
//   const user = useUser()
//   const isMemberOfOrg = !!test.organization;
//   if(!test.isLoaded){
