...
const DoctorDashboard = async () => {
  ...
  return (
    <div className="space-y-8 m-4 h-full">
      ...
      {/* Clerk Subscription Status Banner */}
      {subscriptionContext && (
        <div className="mb-6">
      ...
      {/* Analytics Section - Protected by Clerk Subscription */}
      <ClerkSubscriptionGuard feature="canAccessAnalytics">
        <Card>
          <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <ClerkSubscriptionGuard feature="canUseApiAccess" fallback={
