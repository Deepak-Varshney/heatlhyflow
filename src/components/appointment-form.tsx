// // The updated AppointmentBooking.tsx component
...
//   const handleSubmit = () => {
//     if (!selectedPatient || !selectedDoctor || !selectedTimeSlot) {
//       toast.error("Please select all fields.");
//       return;
//     }
//     // Simulate booking an appointment
//     toast.success(
//       `Appointment booked for ${selectedPatient.firstName} with Dr. ${selectedDoctor.lastName} at ${selectedTimeSlot}`
//     );
...
//             <DialogDescription>
//               Select a patient, doctor, and time slot to complete the booking.
//             </DialogDescription>
//           </DialogHeader>
...
//             {/* Step 2: Select Doctor (Now using the new Combobox) */}
//             <div className="space-y-2">
...
//               disabled={!selectedPatient || !selectedDoctor || !selectedTimeSlot}
//             >
//               Book Appointment
//             </Button>
//           </div>
